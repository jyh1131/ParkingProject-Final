...
<button onclick="location.href ='./RecordsInsert?parking_code=${parking.parking_code}'">주차 기록 등록</button> 
</div>
...
<td>
<button onclick="location.href ='./RecordsSelectDetailParking?records_code=${list.records_code}'">상세 정보</button>
</td>
</tr>
</c:forEach>
