...
<div class="button-container">
	<button onclick="location.href = './RecordsRestUser'">주차 기록 확인(user)</button> <!-- 화진 -->
</div>

<div class="button-container">
	<button onclick="location.href = './ParkingSelectAll?member_code=${sessionScope.customMemberDetails.memberCode}'">주차장 관리(manager)</button> <!-- 화진 -->
</div>

<div class="button-container">
	<button onclick="location.href = './CommentSelectMember'">회원 댓글 작성 목록</button> <!-- 무성님 -->
</div>

<div class="button-container">
	<button onclick="location.href = './FaqSelect'">게시판 전체 조회</button> <!-- 무성님 -->
</div>

<div class="button-container">
	<button onclick="location.href = './NoticeSelect'">공지사항 전체 조회</button> <!-- 무성님 -->
</div>

<div class="button-container">
	<button onclick="location.href = './TicketSearch'">정기권 조회(manager)</button> <!-- 영학님 -->
</div>
