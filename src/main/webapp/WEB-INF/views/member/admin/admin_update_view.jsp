					...
					<div class="card-body">
						<form action="./MemberUpdate" method="post" id="sign_dept">
							<fieldset>
								...
								<div class="form-group row">
									<label for="member_id" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_name" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_password" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_email" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_callnumber" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_birthday" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_gender" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_car_num1" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_car_num2" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
								...
								<div class="form-group row">
									<label for="member_car_num3" class="ml-sm-3 col-form-label"></label>
									<div class="ml-sm-3">
						...
						<div class="row">
							<div class="col-md-4">
								<a href="./MemberSelect" class="btn btn-primary btn-block">회원
									목록</a>
							</div>
							<div class="col-md-4">
								<a href="./MemberInsert" class="btn btn-success btn-block">회원
									입력</a>
							</div>
							<div class="col-md-4">
								<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> <a
									href="./MemberDelete?member_code=${param.member_code}"
