      ...
      <div class="container">
         <div class="row align-items-start justify-content-between">
            <div class="col-md-4 text-left">
               <h1>
                  <i class="fas fa-lock-open"></i>P.K.-Management (admin)
               </h1>
            </div>
...
<div class="button-container">
	<button onclick="location.href = './AdminSelect'">회원 전체 조회</button> <!-- 준혁님 -->
</div>

<div class="button-container">
	<button onclick="location.href = './ParkingSelectAdmin'">주차장 관리(admin)</button> <!-- 화진 -->
	<button onclick="location.href = './RecordsRestAdmin'">주차기록 관리(admin)</button> <!-- 화진 -->
</div>
