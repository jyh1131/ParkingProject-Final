      ...
      <div class="container">
         <div class="row align-items-start justify-content-between">
            <div class="col-md-4 text-left">
               <h1>
                  <i class="fas fa-lock-open"></i>P.K.-Management (manager)
               </h1>
            </div>
...
<div class="button-container">
	...
	<button onclick="location.href = './RecordsRestManager'">주차 기록 확인(manager)</button> <!-- 화진 -->
</div>

<div class="button-container">
	<button onclick="location.href = './CommentSelectParking'">주차장 댓글 작성 목록</button> <!-- 무성님 -->
</div>
