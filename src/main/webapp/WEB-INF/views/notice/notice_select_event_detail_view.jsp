            ...
            if (confirm("정말로 이 이벤트를 삭제하시겠습니까?")) {
                $.ajax({
                    ...
                    success: function(response) {
                        alert("게시글이 삭제되었습니다.");
                        window.location.href = "${pageContext.request.contextPath}/NoticeSelectEvent";
                    },
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <c:if test="${member_rating == 'admin'}">
                                    <a href="${pageContext.request.contextPath}/NoticeUpdateEvent?notice_code=${noticeDTO.notice_code}" class="btn btn-warning">수정</a>
