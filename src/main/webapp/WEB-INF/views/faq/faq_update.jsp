...
<main>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="./FaqUpdate" method="post" id="faq_form">
                                <sec:csrfInput />
                                <fieldset>
                                    <div class="form-group row">
                                        ...
                                        <div class="ml-sm-3">
                                            <input type="text" name="faq_title" id="faq_title"
                                                ...
                                                value="${faqDTO.faq_title}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="faq_question" class="ml-sm-3 col-form-label">내용</label>
                                        <div class="ml-sm-3">
                                            <textarea name="faq_question" id="faq_question"
                                                class="form-control form-control-sm" rows="5">${faqDTO.faq_question}</textarea>
                                        </div>
                                    </div>
                                    <input type="hidden" name="faq_code" value="${faqDTO.faq_code}">
                                    <input type="hidden" name="faq_answer_code"
                                        value="${faqDTO.faq_answer_code}">
    ...
    <a href="./FaqSelect" class="btn btn-primary btn-block"> 게시판 홈으로
        돌아가기</a>
