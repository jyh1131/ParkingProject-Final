...
<main>
							...
							<form action="./FaqAnswerUpdate" method="post" id="faq_form">
								...
								<fieldset>
									<div class="form-group row">
										<label for="faq_answer" class="ml-sm-3 col-form-label">댓글
											내용</label>
										<div class="ml-sm-3">
											<textarea name="faq_answer" id="faq_answer"
												class="form-control form-control-sm" rows="5">${faqDTO.faq_answer}</textarea>
										</div>
									</div>
	...
	<a href="./FaqSelect" class="btn btn-primary btn-block"> 게시판홈으로
		돌아가기</a>
